...
- [ ] `ifconfig eth0 192.168.1.128/25 broadcast 192.168.1.255`
...
- [ ] The computer will send the ICMP message to the `192.168.1.2` router through the eth1 interface.
...
- [ ] `ip neighbour add 192.168.1.10 lladdr 00:40:f5:ab:0f:10 dev eth0`
